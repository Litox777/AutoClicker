...
<img width="330" height="383" alt="Captura de pantalla 2025-12-11 205559" src="https://github.com/user-attachments/assets/759e41af-4f2f-4bfd-92a3-ba2c29ef7b57" />

## Download
If you only want to download the auto-clicker, [click here](https://github.com/Litox777/AutoClicker/releases/tag/v1.0.0). However, if you want to view the source code or run it, you will need to execute the following commands.

<details>
  <summary><code>Windows (PowerShell)</code></summary>
